...
const Sold = () => {
  ...
  useEffect(() => {
    const fetchNFTs = async () => {
      ...
      try {
        ...
        const response = await axios.get(`${server}/api/nft/fetchallsoldnft`, {
          headers: {
            auth_token: token
          },
        });
  ...
  return (
    ...
    <div className="container my-5">
      ...
      {!error && nfts.length === 0 && <div className="text-center" style={{ fontFamily: 'initial', color:'black', fontSize: "35px", fontWeight: 'bold', fontStyle: 'revert' }}>No NFT Yet</div>} {/* Show message when no NFTs are available */}
          ...
          <div className="col-sm-6 col-md-4 col-lg-3" key={index}>
            <div className="card nft-card">
              ...
              <div className="card-body">
                ...
                <Link
                  to='/AdminDetail' // Use Link component for navigation
